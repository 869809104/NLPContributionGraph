...
test_data_dir = '/content/drive/MyDrive/ncg/datasets/trial-data'
articles, entities = loadArticles(test_data_dir)
# print(articles)
# print(sentences)
# print(entities)

test_sentences, test_spans = article2ContributionSentenceAndContributionSpans(articles, entities)
# print('contribution_sentences:', test_sentences)
# print('contribution_spans:', test_spans)
